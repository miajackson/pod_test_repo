...
print('Question 2')
print("using function from other from other file, playlist_function, to check\n".upper())
...
'''
add_song(my_playlist, {'artist': 'The Bee Gees', 'title': 'Night Fever'})

# 4 Check that you've added the song by running the display_playlist() function again
print('Question 4')
print("Checking to see our added song is on the the list".upper())
print()
display_playlist(my_playlist)
...
add_song(my_playlist, {'artist': 'Jahiem', 'title': 'Ghetto Love'})
add_song(my_playlist, {'artist': 'Chris Brown', 'title': 'China'})
display_playlist(my_playlist)
...
print("The average monthly plays for our song:".upper())
print (monthly_plays_avg)
...
print("----------------------------------------")
print()
print("Playing Ghetto Love by Jahiem once".upper())
print()
play_track(my_playlist, 2)
print()
print("Playing Ghetto Love by Jahiem once again".upper())
