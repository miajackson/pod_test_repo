...
'''
add_song(my_playlist,{'artist': 'Machel Montano', 'title': 'Famalay'})
...
add_song(my_playlist, {'artist': 'Machel Montano', 'title': 'Fast Wine'})
add_song(my_playlist, {'artist': 'Machel Montano', 'title': 'Party Done'})
display_playlist(my_playlist)
my_playlist
...
def play_track(my_playlist):
	
	return len(my_playlist)
