...
restaurant_1  = {
    "name": "Five Guys",
    "address" : "73-25 Woodhaven Blvd, Queens, NY 11385",
    "favourite_dish" : "burgers" }

restaurant_2  = {
    "name": "Panera Bread",
    "address" : "89-89 Union Tpke, Queens, NY 11385",
    "favourite_dish" : "pick 2" }
...
print (restaurant_1.pop('favourite_dish'))
...
restaurant_1['update address'] = '61-22 188 Street, Queens, NY, 11356'
print(restaurant_1['update address'])
