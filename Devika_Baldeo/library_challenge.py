...
print(f"book_with_detailsis{type(books_with_details)}")
print(f"index 0 is {type(books_with_details[0])}")
...
print()
print(f"The number of books in book_with details list: {count_books()}")
...
def search_by_author(author):
    ...
    for book in books_with_details:
        if book['author'] == author:
            authors_list.append(book['title'])
            return authors_list
...
#     for book in books_with_details:
#         if book['author'] == author:
#             return list_empty.append(book['title'])
