...
result = sp.search(q= name, limit=3, type = 'artist')  # fill this in
...
artist_info = (sp.artist(artist_id)) # fill this in
...
print(type(artist_info["genres"]))
print(artist_info["genres"][1])
print("Question 5")
...
popularities = []
chosen_artists = ["Machel Montano", "Erykah Badu", "Ana Tijoux", "Aphex Twin", "Yo La Tengo"]
for artist in chosen_artists:
    ...
    artist_info = (sp.artist(artist_id)) # fill this in
    artist_dictionary = {"popularity": artist_info["popularity"]}
    # print(artist_info["popularity"])
    artist_dictionary["name"] = artist

    artist_dictionary["id"] = artist_id
    artist_dictionary["followers"] = artist_info ["followers"]["total"]
    # print(artist_dictionary)
    popularities.append(artist_dictionary)
...
print(popularities)
print(popularities[1])
print(popularities[1]["name"])

# keep pulling info from the dictionary!
