...
add_song(my_playlist, {'artist': 'ac/dc', 'title': 'Back in Black'})
...
print('Question 5')
add_song(my_playlist, {'artist': 'ac/dc', 'title': 'done dirt cheap'})
add_song(my_playlist, {'artist': 'ac/dc', 'title': 'hells bells'})
