...
def withdraw(account, amount):
    if amount <= account['balance']:
        ...
        print(f"You have insufficient funds in your account! Your current balance available is ${account['balance']}")

#postive withdrawl
withdraw(my_account, 3.43)       
print(my_account) 
#negative withdrawl
withdraw(my_account, 22.21)
