...
for laptopnames in all_laptops:
    print(laptopnames)
...
for each_laptop in laptops: #iterating through the laptops
    for each_type in each_laptop["types"]: #now going through types
        print(each_type["price"])
