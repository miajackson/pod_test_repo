...
#print(result['artists']['items'][]['name'])
...
chosen_artists = ['AC/DC', 'Kanye West', 'Maroon 5', 'Eminem', 'David Guetta']
popularities = []


for artists in chosen_artists:
    #print('artists = ' , artists)
    my_artists = sp.search(artists, type='artist', limit=1,)
    artist_id = (my_artists['artists']['items'][0]['id'])
    artist_info =(sp.artist(artist_id))
    #jprint(my_artists)
    artist_dictionary = {'name':artists, 
                        'id':artist_id,
...
print(popularities[3]['popularity'])#highest
print(popularities[0]['popularity'])#lowest
print(popularities[3]['followers'])#highest
print(popularities[1]['followers'])#lowest
