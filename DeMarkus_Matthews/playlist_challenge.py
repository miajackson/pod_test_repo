...
'''
add_song(my_playlist, {'artist': 'Mozzy', 'title': 'Aint Perfect'})
...
print('Question 5')
add_song(my_playlist, {'artist': 'Kendrick Lamar', 'title': 'Loyalty'})
add_song(my_playlist, {'artist': 'Mozzy', 'title': 'Unethical & Deceitful'})
display_playlist(my_playlist)
