...
# TODO: Hmm. Looks like "remaining_50_list" contains the movie "The Matrix" which is also in the "top_50_list". 
...
# TODO: Great! Let's join the two lists into one list called "top_100". Uncomment the line of code below and run your code 
...
print()
print()
print("Top 10 movies on the list")
print(top_100[0:10])
print()
