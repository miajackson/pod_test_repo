...
def check_out(book):                   # a string will be stored in 'book' variable
    books.remove(book)
...
print("Gives not available for books not on list vvv")
search_by_name("American psycho")
print()
...
print()
print(f"book_with_details is {type(books_with_details)}, a list")
print(f"index 0 is {type(books_with_details[0])}, a dictionary")
print("Python told me")
...
print()
print(count_books())
print(f"The number of books in book_with_details list: {count_books()}")
print()
# 2.3
...
def search_by_author(author):
    ...
    for book in books_with_details:
        if book['author'] == author:
            list_empty.append(book['title'])
    return list_empty
    
search_by_author("Timothy Snyder")         # will not print without print function!


# 2.4
# Search for book titles by the author 'Timothy Snyder' using the search_by_author function

print("Timothy wrote the following books:")
print(search_by_author("Timothy Snyder"))
print()
print("Michelle Alexander wrote the following book(s)")
