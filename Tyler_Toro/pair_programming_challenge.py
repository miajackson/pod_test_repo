...
def deposit(account, amount):
    user_account["balance"] += int(float(amount))
    return
    


print("Before deposit".upper())
print(user_account)
print()
deposit(user_account, 1400)
print("\nAfter deposit".upper())
print(user_account)
deposit(user_account, 1400)
print("\nAdditional deposit, checking for +=".upper())
print(user_account)
...
def withdraw(account, amount):
    if int(float(amount)) > user_account["balance"]:
        print("You do not have enough funds available")
    else:
        user_account["balance"] -= int(float(amount))


print(f"Current funds available: {user_account['balance']}\n\n")
print("Withdraw $300")
withdraw(user_account, 300)
print(f"Current funds available: {user_account['balance']}")
print("\nWithdraw ANOTHER $300")
withdraw(user_account, 300)
print(f"Current funds available: {user_account['balance']}")
print("\n\nAttempting to withdraw $3000 from account:\n")
#withdraw(user_account, 3000)
print("<code successfuly prints \"you do not have enough funds available\">\n")
