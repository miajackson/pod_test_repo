...
print('Added colon, corrected name \"meet\" to \"meat\" , wrong iterator\n')
...
print('Added quotation marks around curly brackets in line 39\n')
...
try:
    ...
    print("You entered a list and/or Dictionary - Something went wrong!\n")
finally:
    print("The end\n")
