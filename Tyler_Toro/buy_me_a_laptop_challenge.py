...
print()
print("The url for the Apple Macbook Pro:")
print(laptops[0]["url"])
...
print(laptops[1]["types"][1]["colors"])

# TODO: Write code to print the description of Dell XPS laptop.
print()
print("The description of Dell XPS:")
...
for price in laptops:                 # outer loop goes through each computer    
    for each_type in price["types"]:   # inner loop, deeper into dictionary
        print(each_type["price"])          # price specifically printed