...
print('Question 2')
print()
#using the function display playlisy
...
'''
# adding the song to myplaylist

add_song(my_playlist, {'artist': 'Lupe Fiasco', 'title': 'Kick Push'})
...
add_song(my_playlist, {'artist': 'Chance the Rapper', 'title': 'Cocoa Butter Kisses'})
add_song(my_playlist, {'artist': 'Wale', 'title': 'Sue Me'})
...
print('Question 6')
print()
# on the challenge I should be able to call this right?
get_playlist_length(my_playlist) # i am trying use get_playlist_length to display

print(f'Playlist has {get_playlist_length(my_playlist)} songs')
print()
...
playlist_ave = np.mean(monthly_plays)

print(f'The mean amount for monthly plays is {int(playlist_ave)}')
print()
