...
def create_account():
    username = input("Create your usernamer? ")
...
def withdraw(account, amount):
    if amount <= account["balance"]:
        ...
        print(f'You have insufficient funds to make this transaction. This account only has {account["balance"]}')
