...
# offset window- is this for list or dictionary*****
...
'''
# top_artist = sp.search(name, type="artist", limit=1, market="US") 
# ***first way attempt before office hours***
# jprint(top_artist)
'''


print(result['artists']['items'][0]['name'])
print(result['artists']['items'][1]['name'])
print(result['artists']['items'][2]['name'])

print(result['artists']['items'][0]['id'])
print(result['artists']['items'][1]['id'])
print(result['artists']['items'][2]['id'])
#
...
artist_id = result["artists"]["items"][0]["id"]  # **** what is so important about the result when searching ****
# jprint(artist_id)               # **** How to print out top artist id****
...
chosen_artists = ["Kendrick Lamar", "Drake", "Big Sean", "Chance The Rapper", "Kayne West"]
popularities = []

for artist in chosen_artists:                           
    artist_search = sp.search(artist, type="artist")
    #print(artist_search)        # we just defined sp.search(artist, type="artist")       
    artist_id = artist_search["artists"]["items"][0]["id"]
    #print(artist_id)
    new_artist_info = sp.artist(artist_id)
    artist_dict = {}
    ...
    popularities.append(artist_dict)
...
print(popularities[0]['name'], popularities[0]['popularity'])
print(popularities[1]['name'], popularities[1]['popularity'])
print(popularities[2]['name'], popularities[2]['popularity'])
print(popularities[3]['name'], popularities[3]['popularity'])
print(popularities[4]['name'], popularities[4]['popularity'])
